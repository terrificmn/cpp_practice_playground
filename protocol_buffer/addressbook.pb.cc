...
constexpr auto Person::InternalNewImpl_() {
  ...
  if (arena_bits.has_value()) {
    return ::google::protobuf::internal::MessageCreator::CopyInit(sizeof(Person), *arena_bits);
  } else {
...
constexpr auto AddressBook::InternalNewImpl_() {
  ...
  if (arena_bits.has_value()) {
    return ::google::protobuf::internal::MessageCreator::ZeroInit(sizeof(AddressBook), *arena_bits);
  } else {
